...
# Per-variant EDGE — calibrated from live A/B between EDGE=2 and EDGE=8.
# VANILLA: EDGE=8 made +923 vs +6 -> keep wide
# STRAWBERRY: EDGE=8 made +771 vs +635 -> keep wide
# RASPBERRY: EDGE=8 made -454 vs -759 -> moderate widening
# CHOCOLATE: EDGE=8 made -499 vs +366 -> revert to narrow
# PISTACHIO: EDGE=8 made 0 vs +329 -> revert to narrow
PER_PRODUCT_EDGE = {
    "SNACKPACK_VANILLA": 8,
