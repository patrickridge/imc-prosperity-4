"""Parameter sweep for the MICROCHIP MM strategy.

Sweeps OBI_SKEW, INVENTORY_PENALTY, EDGE.

Run as: python3 research/round5_microchip_sweep.py
"""
...
STRATEGY_TEMPLATE = (REPO / "strategies" / "r5_microchip_lead_lag.py").read_text()

DAYS = [2, 3, 4]
OBI_SKEWS = [0.5, 0.8, 1.0, 1.5]
