...
_VEV_POS_CAP: Dict[str, int] = {
    ...
    "VEV_5200": 150, "VEV_5300": 150, "VEV_5400": 200, "VEV_5500": 200,
}
_VEV_LOT: Dict[str, int] = {
    "VEV_4000": 20, "VEV_4500": 20, "VEV_5000": 25, "VEV_5100": 25,
    "VEV_5200": 25, "VEV_5300": 25, "VEV_5400": 40, "VEV_5500": 40,
}
_VEV_LIMIT = 300
_VEV_GROSS_CAP = 1_500
_VEV_PORTFOLIO_DELTA_CAP = 1_500.0

# Live IMC: VEV_4000=-17, VEV_4500=-44, VEV_5500=0. Wings bleed; disable bid wings.
_VEV_MM_BID_STRIKES: Tuple[str, ...] = ()
...
# TODO(Kieran): pick the smile-vs-Heston blend. See _iv_for_strike below.
_SMILE_STRENGTH = 0.0
...
def _iv_for_strike(sym: str, tracked_vol: float) -> float:
    ...
    smile = _VEV_SMILE_OFFSET[sym] * _SMILE_STRENGTH
