...
VELVETFRUIT_ENTRY_LONG = 11.0
VELVETFRUIT_ENTRY_SHORT = 13.0
VELVETFRUIT_CLIP = 50
...
def _trade_velvetfruit(od: OrderDepth, position: int) -> List[Order]:
    ...
    if mid < VELVETFRUIT_ANCHOR - VELVETFRUIT_ENTRY_LONG and position < VELVETFRUIT_LIMIT:
    ...
    elif mid > VELVETFRUIT_ANCHOR + VELVETFRUIT_ENTRY_SHORT and position > -VELVETFRUIT_LIMIT:
