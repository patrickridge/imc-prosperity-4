...
Usage: python utils/visualize.py <day> [round]
Example: python utils/visualize.py -1
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python utils/visualize.py <day> [round]")
        print("Example: python utils/visualize.py -1")
        sys.exit(1)
