...
# FIX: VEV_4000 bid offset raised from 8.0 to 9.5 — verified optimal vs Mark 38 bot.
# Sharp cliff at 10.0 (loses 51 fills). Adds ~+429 PnL/day (+19%).
...
# FIX: R4 options expire in 4 days at round start (not 8). Corrected schedule.
