...
def version_callback(value: bool) -> None:
    if value:
        print(f"backtester {metadata.version(__package__)}")
        sys.exit(0)
...
def cli(
    ...
    data: Annotated[Optional[Path], Option(help="Path to data directory. Must look similar in structure to https://github.com/jmerle/imc-prosperity-3-backtester/tree/master/backtester/resources.", show_default=False, exists=True, file_okay=False, dir_okay=True, resolve_path=True)] = None,
